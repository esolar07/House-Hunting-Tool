...
var displayLightbox = () =>{
    add.addEventListener('click', function(){
        tl.to(lightbox, .1, {css:{transform: "scale(1)"}, ease:Power4.easeOut})
        .from(form, .5,{y:-50, autoAlpha:0, ease:Sine.easeOut},'+=0.1')
        .staggerFrom(fields, .5, {y:-10, autoAlpha:0, ease:Sine.easeOut},'+=0.1')
        .from(submit, .5,{y:-30, autoAlpha:0, ease:Sine.easeOut},'+=0.1')
    });
}
